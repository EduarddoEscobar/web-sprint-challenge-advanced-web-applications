...
1. Explain what a token is used for.
    A token is used to Authenticate that a user can access certain parts of the application
2. What steps can you take in your web apps to keep your data secure?
    You can keep everything on cookies and make sure the api has some form authentication
3. Describe how web servers work.
    The user types in a website url, that url then gets passed from your internet access provider to the server, then the server locates and retrieves the information and resources needed, then sends everything back to the user
